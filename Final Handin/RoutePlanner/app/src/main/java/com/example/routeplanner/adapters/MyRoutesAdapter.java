...
public class MyRoutesAdapter extends RecyclerView.Adapter<MyRoutesAdapter.ViewHolder> {
    private ArrayList<MyRoute> routes;

    public MyRoutesAdapter() {
    }

    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull final ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_route_list_item, parent, false);
    ...
    public void setRoutes(ArrayList<MyRoute> routes) {
        this.routes = routes;
